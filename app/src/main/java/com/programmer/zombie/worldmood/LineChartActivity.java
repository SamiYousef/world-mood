...
public class LineChartActivity extends AppCompatActivity {
    ...
    LineDataSet negativeLine, positiveLine;
    int i = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        negativeLine = new LineDataSet(valueSetNegative, "Negative Line");
        negativeLine.setDrawCubic(true);
        negativeLine.setColor(Color.RED);

        positiveLine = new LineDataSet(valueSetPos, "Positive Line");
        positiveLine.setDrawCubic(true);
            ...
            public void onSuccess(String response) {
                try {
                    ...
                    if (obj.getBoolean("status")) {
                        ...
                        LineData data = new LineData(labels, positiveLine);
                        data.addDataSet(negativeLine);

                        chart.setData(data);
                        chart.setDescription(MainActivity.tweet + "  Line Chart");
                        chart.animateXY(2000, 2000);
                        chart.invalidate();

                        //data.addEntry(new Entry(4f,i),0);****************search
