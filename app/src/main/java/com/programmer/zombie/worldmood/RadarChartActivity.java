...
public class RadarChartActivity extends AppCompatActivity {
    ...
    RadarDataSet negativeLine, positiveLine;
    int i = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        negativeLine = new RadarDataSet(valueSetNegative, "Negative Line");
        negativeLine.setColor(Color.RED);

        positiveLine = new RadarDataSet(valueSetPos, "Positive Line");
            ...
            public void onSuccess(String response) {
                try {
                    ...
                    if (obj.getBoolean("status")) {
                        ...
                        RadarData data = new RadarData(labels, positiveLine);
                        data.addDataSet(negativeLine);
                        chart.setData(data);
                        chart.setDescription(MainActivity.tweet + "  Radar Chart");
